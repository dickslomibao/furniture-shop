		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group mt-3">
					<label for="" class="control-label">GCash QR Code</label>
					<div class="custom-file">
						<input type="file" class="custom-file-input rounded-circle" id="customFile2" name="gcash" onchange="displayImg2(this,$(this))">
						<label class="custom-file-label" for="customFile2">Choose file</label>
					</div>
				</div>
			</form>
			<div class="">
				<img  src="<?php echo validate_image($_settings->info('gcash')) ?>" alt="" class="">
			</div>
		</div>
