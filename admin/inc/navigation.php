            ...
            <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview" style="display: none;">
                  ...
                  <li class="nav-item">
                    <a href="./?page=orders&status=4" class="nav-link tree-item nav-orders_4">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Pending</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="./?page=orders&status=5" class="nav-link tree-item nav-orders_5">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Processed</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="./?page=orders&status=6" class="nav-link tree-item nav-orders_6">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Ready for Delivery</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="./?page=orders&status=7" class="nav-link tree-item nav-orders_7">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Out for Delivery</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="./?page=orders&status=8" class="nav-link tree-item nav-orders_8">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Completed</p>
                    </a>
                  </li>
